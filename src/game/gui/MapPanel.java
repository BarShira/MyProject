    ...
    public void refresh(Position playerPos) {
        for (int row = 0; row < size; row++) {
            for (int col = 0; col < size; col++) {
                ...
                int distance = pos.distanceTo(playerPos);
